...
## 20. คู่มือการใช้งาน L298N Motor Driver กับบอร์ด SKATE (ESP32 / KidBright)

---

### 20.1 รู้จักกับ L298N Motor Driver
...
### 20.3 ตารางควบคุมทิศทาง (Truth Table)
...
### 20.4 การเชื่อมต่อกับบอร์ด SKATE (ESP32)
...
### 20.6 ตัวอย่างโค้ด (Arduino / ESP32)

#### 20.6.1 ควบคุมทิศทางพื้นฐาน (ไม่มี PWM)
...
#### 20.6.2 ควบคุมความเร็วด้วย PWM (ESP32 `ledcWrite`)
...
### 20.7 ใช้ L298N กับ KidBright ได้ไหม?
